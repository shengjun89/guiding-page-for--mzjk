...
scrolltoX = (x) ->
	...
	coin.x = Utils.modulate(x,[0,Screen.width],[-320,96],false)
	coin.y = Utils.modulate(x,[0,Screen.width],[300,620],false)
	coin.opacity = Utils.modulate(x,[0,Screen.width],[0,0.5],false)
	...
	coin2.x = Utils.modulate(x,[0,Screen.width],[Screen.width,Screen.width-300],false)
